...
\label{sec:org7bb73b3}
\begin{mdframed}
\begin{description}
\item[{Nombre de la actividad}] \{\{\{title\}\}
\item[{Fecha}] 2022-09-11
...
\item \href{https://github.com/Galindo-lab/EDD-2022/blob/main/07-09-2022/src/lista-sencilla.c}{Repositorio de Github}
\end{description}
\end{mdframed}

\section*{Prodecimieto}
\label{sec:org937bb4b}
